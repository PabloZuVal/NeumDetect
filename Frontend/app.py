...
def predict_vertex(image):
    return send_prediction_request(image, "vertex")
...
MODELS = {
    ...
    "Modelo Vertex AI": predict_vertex,
...
logo_path = os.path.join(current_dir, '..', 'img', 'NeumDetectPNG2.png')

# Mostrar la imagen centrada en el encabezado
display_centered_image(logo_path, width=400)  # Ajusta la ruta y el ancho según sea necesario
...
with col1:
    ...
    st.write("Los modelos disponibles son VGG16 y VertexAI.")
